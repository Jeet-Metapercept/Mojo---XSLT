...
<!-- Custom Attributes -->
  <xsl:attribute-set name="__body__first__footer__block">
    ...
    <xsl:attribute name="width">17.5cm</xsl:attribute>
    <xsl:attribute name="left">2cm</xsl:attribute>
  </xsl:attribute-set>
  
  <xsl:attribute-set name="__body__first__footer__pagenum__block">
    <xsl:attribute name="position">absolute</xsl:attribute>
    <xsl:attribute name="left">0.0cm</xsl:attribute>
    <xsl:attribute name="border-right-style">solid</xsl:attribute>
    <xsl:attribute name="border-width">3pt</xsl:attribute>
    <xsl:attribute name="border-color">#7E7E7E</xsl:attribute>
    <xsl:attribute name="width">2cm</xsl:attribute>
  </xsl:attribute-set>
<!--/-->
  ...
  <xsl:attribute-set name="pagenum">
    ...
    <xsl:attribute-set name="__chapter__frontmatter__number__container">
        <xsl:attribute name="font-size">20pt</xsl:attribute>
               <xsl:attribute name="font-family">FontMojo</xsl:attribute>
      <xsl:attribute name="color">#595959</xsl:attribute>
     <xsl:attribute name="line-height">3pt</xsl:attribute>
        <!--<xsl:attribute name="font-weight">bold</xsl:attribute>-->
    </xsl:attribute-set>
