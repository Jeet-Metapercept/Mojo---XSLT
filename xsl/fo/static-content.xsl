...
<!--                <xsl:call-template name="insertVariable">
    ...
    <xsl:template name="insertBodyFirstFooter">
        ...
        <fo:static-content flow-name="first-body-footer">
            <!-- Manage Footer -->
            <fo:block-container border-top-style="solid" border-top-width="1.5pt" border-color="#595959" width="15.6cm" position="absolute" left="2cm+10mm">
                <fo:block start-indent="1.5cm" xsl:use-attribute-sets="__body__odd__footer">
                    <xsl:call-template name="insertVariable">
                        ...
                        <xsl:with-param name="theParameters">
                            ...
                            <pagenum>
                                <fo:block-container position="absolute" left="0cm" border-right-style="solid" border-width="1.5pt" border-color="#595959" width="2.2cm" >
                                    <fo:block padding-top="3pt" xsl:use-attribute-sets="__body__odd__footer__pagenum">
                                        <fo:page-number/>
                                    </fo:block>
                                </fo:block-container>
                            </pagenum>
            ...
            <fo:block-container border-top-style="solid" border-top-width="1.5pt" border-color="#595959" width="15.6cm" position="absolute" left="2cm+10mm">
                ...
                <xsl:call-template name="insertVariable">
                    ...
                    <xsl:with-param name="theParameters">
                        ...
                        <pagenum>
                            <fo:block-container position="absolute" left="0cm" border-right-style="solid" border-width="1.5pt" border-color="#595959" width="2.2cm" >
                                <fo:block padding-top="5pt" xsl:use-attribute-sets="__body__odd__footer__pagenum">
                                    <fo:page-number/>
                                </fo:block>
                            </fo:block-container>
                        </pagenum>
    ...
    <xsl:template name="insertTocOddFooter">
        <fo:static-content flow-name="odd-toc-footer">
            <!--Manage TOC footer-->
            <fo:block-container border-top-style="solid" border-top-width="1.5pt" border-color="#595959" width="15.6cm" position="absolute" left="2cm+10mm">
                <fo:block start-indent="1.5cm" xsl:use-attribute-sets="__toc__odd__footer">
                <xsl:call-template name="insertVariable">
